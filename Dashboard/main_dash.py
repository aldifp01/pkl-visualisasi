...
def main_page():
    ...
    df = pd.read_excel('D:/UB/Materi/PKL/Dashboard/main/main_dataset.xlsx', sheet_name='df')
    df_aeq = pd.read_excel('D:/UB/Materi/PKL/Dashboard/main/main_dataset.xlsx', sheet_name='aeq')
    df_dass = pd.read_excel('D:/UB/Materi/PKL/Dashboard/main/main_dataset.xlsx', sheet_name='dass')
    df_erq = pd.read_excel('D:/UB/Materi/PKL/Dashboard/main/main_dataset.xlsx', sheet_name='erq')
    df_nilai = pd.read_excel('D:/UB/Materi/PKL/Dashboard/main/main_dataset.xlsx', sheet_name='nilai')
